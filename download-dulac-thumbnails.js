...
// Main function
async function downloadDulacThumbnails() {
  try {
    console.log('Loading Dulac, Louisiana businesses...');
    ...
    const resultsFile = './dulac-download-results.json';
    fs.writeFileSync(resultsFile, JSON.stringify({
      summary: {
        total: dulacBusinesses.length,
        downloaded,
        skipped,
        errors,
